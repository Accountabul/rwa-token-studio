...
export const WORK_ORDER_PERMISSIONS: EntityPermissionMatrix = {
  entity: "WORK_ORDER",
  actions: {
    VIEW: ["SUPER_ADMIN", "SYSTEM_ADMIN", "FINANCE_OFFICER", "OPERATIONS_ADMIN", "PROPERTY_OPERATIONS_MANAGER", "TECHNICIAN"],
    VIEW_LIST: ["SUPER_ADMIN", "SYSTEM_ADMIN", "FINANCE_OFFICER", "AUDITOR", "OPERATIONS_ADMIN", "PROPERTY_OPERATIONS_MANAGER", "TECHNICIAN"],
    CREATE: ["SUPER_ADMIN", "SYSTEM_ADMIN", "TOKENIZATION_MANAGER", "OPERATIONS_ADMIN", "PROPERTY_OPERATIONS_MANAGER"],
    UPDATE: ["SUPER_ADMIN", "SYSTEM_ADMIN", "TOKENIZATION_MANAGER", "OPERATIONS_ADMIN", "PROPERTY_OPERATIONS_MANAGER", "TECHNICIAN"],
    DELETE: [],
    APPROVE: ["SUPER_ADMIN", "SYSTEM_ADMIN", "FINANCE_OFFICER", "OPERATIONS_ADMIN", "PROPERTY_OPERATIONS_MANAGER"],
    REJECT: ["SUPER_ADMIN", "SYSTEM_ADMIN", "FINANCE_OFFICER", "OPERATIONS_ADMIN", "PROPERTY_OPERATIONS_MANAGER"],
    EXPORT: ["SUPER_ADMIN", "SYSTEM_ADMIN", "AUDITOR"],
  },
};
