...
const navItems = [
  { label: "Tokenization Projects", icon: LayoutDashboard, active: true },
  { label: "Investor Onboarding", icon: Users, disabled: true },
        ...
        {navItems.map((item) => (
          <button
            ...
            className={cn(
              ...
              item.disabled && "text-sidebar-muted/50 cursor-not-allowed"
            )}
          >
